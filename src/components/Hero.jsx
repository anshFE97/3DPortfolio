    ...
    <section className="relative w-full h-screen mx-auto">
      ...
      flex-row items-start gap-5`}>
        ...
        <div>
          ...
          className="text-[#915eff]">Anshul</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I'm developing 3D visuals, user <br className="sm:block hidden" />interface and web applications.
          </p>
        </div>
      </div>
      ...
      bottom-32 w-full flex justify-center items-center">
        <a href="#about">
          <div className="w-[35px] h-[54px] rounded-3xl
